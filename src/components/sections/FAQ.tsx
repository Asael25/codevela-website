        ...
        <section id="faq" className="py-10 md:py-13 border-t border-base-gray-light">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                {filteredFaqs.length === 0 ? (
                    ...
                    <>
                        {/* ============================================================ */}
                        {/* 1. MOBILE ACCORDION VIEW (< lg): Jawaban Tepat di Bawah Item */}
                        {/* ============================================================ */}
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-start gap-2.5 sm:gap-3 min-w-0">
                                                ...
                                                <span
                                                    className={`font-mono text-xs font-bold px-2 py-0.5 rounded transition-colors shrink-0 ${isExpanded
                                                        ? "bg-base-black text-base-white"
                                                        : "bg-base-subtle text-base-gray-dark"
                                                        }`}
                                                >
                                                    {questionNumber}
                                                </span>
                                                ...
                                                <div className="min-w-0">
                                                    <h3
                                                        className={`text-xs sm:text-sm leading-snug transition-colors ${isExpanded
                                                            ? "text-base-black font-semibold"
                                                            : "text-base-gray-dark font-medium"
                                                            }`}
                                                    >
                                                        {faq.question}
                                                    </h3>
                                            ...
                                            <div
                                                className={`shrink-0 w-6 h-6 rounded-md flex items-center justify-center transition-all ${isExpanded
                                                    ? "bg-base-black text-base-white"
                                                    : "text-base-gray-medium"
                                                    }`}
                                            >
                                                <ChevronRight
                                        ...
                                        {/* Mobile Accordion Panel Directly Below Bubble */}
                                        <AnimatePresence initial={false}>
                                            {isExpanded && (
                                                ...
                                                >
                                                    <div className="px-3.5 pb-4 pt-1 sm:px-4 sm:pb-4 border-t border-base-subtle space-y-3.5">
                                                        {/* Answer Text */}
                                                        <p className="text-xs sm:text-sm text-base-gray-dark leading-relaxed pt-2">
                                                            {faq.answer}
                                                        </p>
                                                        ...
                                                        {faq.keyPoints && faq.keyPoints.length > 0 && (
                                                            <div className="pt-2">
                                                                <span className="text-[10px] font-mono uppercase tracking-wider text-base-gray-medium font-semibold block mb-2">
                                                                    Poin Penting:
                                                                </span>
                                                                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                                                                    {faq.keyPoints.map((point) => (
                                                                        <div
                                                                            key={point}
                                                                            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-base-subtle border border-base-gray-light/70 text-[11px] font-mono text-base-gray-dark"
                                                                        >
                                                        ...
                                                        <div className="pt-2">
                                                            <a
                                                                href={`https://wa.me/${CONTACT.admins[0].phone}?text=${encodeURIComponent(
                                                                    `Halo Codevela, saya ingin tanya lebih lanjut mengenai: "${faq.question}"`
                                                                )}`}
                                                                target="_blank"
                                                                rel="noopener noreferrer"
                                                                className="inline-flex items-center justify-center gap-1.5 w-full py-2.5 px-3 rounded-xl bg-base-black text-base-white font-mono text-xs font-semibold hover:bg-base-gray-dark active:scale-95 transition-all cursor-pointer shadow-sm"
                                                            >
                                                                <span>Tanya Topik Ini via WhatsApp</span>
                        ...
                        {/* ============================================================ */}
                        {/* 2. DESKTOP VIEW (>= lg): 2-Column Master-Detail Layout TETAP  */}
                        {/* ============================================================ */}
                ...
                <div className="mt-8 p-4 sm:p-6 rounded-2xl border border-base-gray-light bg-base-white shadow-sm flex flex-col sm:flex-row items-center justify-between gap-5">
